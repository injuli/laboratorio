...
require 'Proyecto Reserva Laboratorio/model/laboratorio.class.php';
 ...
 */
  ...
  //carga la plantilla 
  $pagina=$this->load_template('- Reservar -');
  //carga html del buscador
       $buscador = $this->load_page('/views/default/modules/m.buscador.php');
 ...
 */
  ...
  $html = $this->load_page('views/default/modules/principal.php');
